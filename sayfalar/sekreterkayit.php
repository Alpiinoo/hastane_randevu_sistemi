...
<body>
    ...
    <div class="TableOuter">
        <h1 style="color: black;">Sekreter Kayıt</h1>
        <form action="sregister.php" method="post">
    <div class="user">
        <input type="text" class="alan" name="sisim" id="sad" placeholder="İsim" required>
    </div>
    <div class="user">
        <input type="text" class="alan" name="ssoyisim" id="hsoyisim" placeholder="Soyisim" required>
    </div>
    <div class="user">
        <input type="number" class="alan" name="skno" id="skno" placeholder="Kimlik Numarası" required>
    </div>
    <button type="submit" class="button1">Sekreter Kayıt</button>
</form>
